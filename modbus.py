    ...
    def execute1(self,slave,data):
        ...
        if slave != 0:
            ...
            try:
                 ...
                 fc_code = ""
                 for i in response_pdu:
                     fc_code = fc_code + bytes_to_hex(i)
                 # print('response', fc_code)
                 # return 0 正常9
                 if fc_code[14:16] == data[14:16]:
                     return 0,fc_code
                 # return 1 功能码异常
                 elif fc_code[-2:] == "01" or fc_code == "" :
                     return 1,fc_code
                 # return 2 地址异常
                 elif fc_code[-2:] == "02":
                     return 2,fc_code
                 ...
                 print("response 从机无反应，发送的报文为：",data)
                 return 5,"non"

    # /////////////////////////////////////////////
    @threadsafe_function
    def execute(self, slave, function_code, starting_address, quantity_of_x=0, output_value=0, data_format="", expected_length=-1, write_starting_address_FC23=0):
        """
        ...
        arr=""
        for i in request:
            arr=arr+bytes_to_hex(i)
            #print(bytes_to_hex(i), end=" ")
        #print(arr)
        ftxt=open("modbus_train.txt",'a+')
        ftxt.write(arr[0:16]+""+arr[16:]+" "+"1"+"\n")
        ftxt.close()
